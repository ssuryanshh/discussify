...
function JoyJunctionScreen({userInfo}) {
  return (
    <div className='joy-junction-screen-container'>
      ...
      <div className='music'>
        <h2>Music</h2>
      <iframe style={{"border-radius":"12px"}} title = "Spotify" src="https://open.spotify.com/embed/playlist/37i9dQZF1DX3rxVfibe1L0?utm_source=generator" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
      </div>
      </div>
    </div>
  )
